...
export async function seed() {
  await withDb(async (db) => {
    ...
    // users
    // -------------------------------------------------------------------------
    const { insertedId: user1Id } = await db
      .collection("users")
      .insertOne({ firstName: "John", lastName: "Smith" });
    const { insertedId: user2Id } = await db
      .collection("users")
      .insertOne({ firstName: "Jane", lastName: "Doe" });

    // -------------------------------------------------------------------------
    // books
    // -------------------------------------------------------------------------
    const { insertedId: spiderMan1Id } = await db
      .collection("books")
      .insertOne({
    ...
    await db.collection("booksPricesAnalyses").insertOne({
      ...
      prices: [
        {
          grade: new Double(4.0),
          rawPrice: new Double(280),
          slabPrice: new Double(340),
        },
        {
          grade: new Double(6.0),
          rawPrice: new Double(550),
          slabPrice: new Double(650),
        },
        {
          grade: new Double(8.0),
          rawPrice: new Double(1100),
          slabPrice: new Double(1300),
        },
        {
          grade: new Double(9.0),
          rawPrice: new Double(2400),
          slabPrice: new Double(2800),
        },
        {
          grade: new Double(9.8),
          rawPrice: new Double(8500),
          slabPrice: new Double(9500),
        },
      ],
    });
    ...
    await db.collection("booksPricesAnalyses").insertOne({
      ...
      prices: [
        {
          grade: new Double(4.0),
          rawPrice: new Double(900),
          slabPrice: new Double(1100),
        },
        {
          grade: new Double(6.0),
          rawPrice: new Double(1800),
          slabPrice: new Double(2200),
        },
        {
          grade: new Double(8.0),
          rawPrice: new Double(5000),
          slabPrice: new Double(6000),
        },
        {
          grade: new Double(9.0),
          rawPrice: new Double(12000),
          slabPrice: new Double(15000),
        },
      ],
    });
  });
